    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li><a href="show_modul.php">Modul</a></li>
        </ul>
  ...
  <div class="container-fluid text-center">
    <div class="row">
      <div class="col-sm-10 text-left">
        ...
        ?>
        <div class="clearfix">
          <a href="add_streams.php" class="btn btn-success" style="margin-bottom: 20px">Add</a>
        </div>
      </div>
      <div class="col-sm-2 sidenav">
        <h4 style="font-weight: bold;">Announcement</h4>
        <div class="clearfix">
          <a href="add_information.php" class="btn btn-success" style="margin-bottom: 20px">Add</a>
        </div>
        <?php
        include "koneksi.php";
