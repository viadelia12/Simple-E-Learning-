...
<body>
    ...
    <div class="clearfix">
        <a href="modul_admin.php" class="btn btn-success" style="margin: 20px">Add Modul</a>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php
                    if ($data['status'] == 1) {
                        ?><a href=dekripsi_file.php?id_file=<?php echo $data['id_file']; ?>><button>Dekripsi</button></a>
                        <?php
